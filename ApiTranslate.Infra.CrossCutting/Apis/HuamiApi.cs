    ...
    public class HuamiApi : IHuamiApi
    {
        public async Task<CredentialResponse> GetHuamiCredentials(string deviceId) // "FE:22:50:4B:49:D2",
        {
            ...
            try
            {
                ...
                request.AddParameter("code", HttpUtility.HtmlEncode("ya29.a0Aa4xrXP_Yg26bMmhI0e4k49nOJtDwu6Xtw4_epjB3sopj5Vb6RS_eWpn6N1KoNV3accsGNpVbSMMTewIduxFVu8x3MdfIi1ZYCQkCMhYFuViYEPBVIi5J1ZZiS6LQHLcvRh20BicZJeAEopFGNHJd35P7U0CaCgYKATASARISFQEjDvL9aBPyf7qm-XOBZnRA8OBxaQ0163"));
